...
public class CipherUtil
{
     ...
     * @return 返回加密解密后的数据
     */
    private static String PBECipher(String data, String password, String salt,
            int mode)
    {
        try
        {
            ...
            PBEParameterSpec paramSpec = new PBEParameterSpec(
                    TranscodeUtil.base64StrToByteArray(salt), 100);
            ...
            String algorithmParameter, int mode)
    {
        try
        {
            ...
            return mode == Cipher.DECRYPT_MODE ? new String(
                    ecipher.doFinal(TranscodeUtil.base64StrToByteArray(data)))
     ...
     * @return 加密结果
     */
    public static String DHEncrypt(String data, String publicKey,
            String privateKey)
    {
        try
        {
     ...
     * @return 返回解密结果
     */
    public static String DHDecrypt(String data, String publicKey,
            String privateKey)
    {
        try
        {
     ...
     * @return 返回私钥
     */
    private static PrivateKey getKeyStorePrivateKey(String keyStorePath,
            ...
            String alias, String password)
    {
        ...
        {
            // 取得私钥
            PrivateKey privateKey = getKeyStorePrivateKey(keyStorePath,
                    alias,
                    password);
            // 对数据加密
     ...
     * @return 返回解密后的数据
     */
    public static String decryptByPrivateKey(String data, String keyStorePath,
            String alias, String password)
    {
        try
        {
     ...
     * @return 返回签名信息
     */
    public static String sign(String sign, String keyStorePath, String alias,
            String password)
    {
        try
        {
