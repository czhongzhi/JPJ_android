 ...
 *地区选择 
 */
public class SetAreaActivity extends BaseActivity implements OnClickListener {
	...
	private void loadSpinner() {
		...
		province_spinner.setPrompt(getResources().getString(R.string.choose_province));
				...
				.setOnItemSelectedListener(new OnItemSelectedListener() {
					...
					public void onItemSelected(AdapterView<?> arg0, View arg1,
						...
						if (true) {
							...
							city_spinner = (Spinner) findViewById(R.id.city_spinner);
							city_spinner.setPrompt(getApplication().getResources().getString(R.string.choose_city));
									...
									.setOnItemSelectedListener(new OnItemSelectedListener() {
										...
										public void onItemSelected(
											...
											if (true) {
												county_spinner = (Spinner) findViewById(R.id.county_spinner);
												county_spinner
														.setPrompt(getApplication().getResources().getString(R.string.choose_county));
												switch (provinceId) {
												case 0:
	...
	private  int checkProvice(String proviceString){
		int j = 0;
		String[] items = getResources().getStringArray(R.array.province_item);
		for(int i = 0;i<items.length;i++){
			if(proviceString.equalsIgnoreCase(items[i])){
				j=i;
				return j;
			}
		}
	...
	private  int checkCity(int provinceId,String cityString){
		int j = 0;
		String[] items;
		switch (provinceId) {
		case 0:
			items = getResources().getStringArray(R.array.beijin_province_item);
			...
			break;
		case 1:
			items = getResources().getStringArray(R.array.tianjin_province_item);
			...
			break;
		case 2:
			items = getResources().getStringArray(R.array.heibei_province_item);
			...
			break;
		case 3:
			items = getResources().getStringArray(R.array.shanxi1_province_item);
			...
			break;
		case 4:
			items = getResources().getStringArray(R.array.neimenggu_province_item);
			...
			break;
		case 5:
			items = getResources().getStringArray(R.array.liaoning_province_item);
			...
			break;
		case 6:
			items = getResources().getStringArray(R.array.jilin_province_item);
			...
			break;
		case 7:
			items = getResources().getStringArray(R.array.heilongjiang_province_item);
			...
			break;
		case 8:
			items = getResources().getStringArray(R.array.shanghai_province_item);
			...
			break;
		case 9:
			items = getResources().getStringArray(R.array.jiangsu_province_item);
			...
			break;
		case 10:
			items = getResources().getStringArray(R.array.zhejiang_province_item);
			...
			break;
		case 11:
			items = getResources().getStringArray(R.array.anhui_province_item);
			...
			break;
		case 12:
			items = getResources().getStringArray(R.array.fujian_province_item);
			...
			break;
		case 13:
			items = getResources().getStringArray(R.array.jiangxi_province_item);
			...
			break;
		case 14:
			items = getResources().getStringArray(R.array.shandong_province_item);
			...
			break;
		case 15:
			items = getResources().getStringArray(R.array.henan_province_item);
			...
			break;
		case 16:
			items = getResources().getStringArray(R.array.hubei_province_item);
			...
			break;
		case 17:
			items = getResources().getStringArray(R.array.hunan_province_item);
			...
			break;
		case 18:
			items = getResources().getStringArray(R.array.guangdong_province_item);
			...
			break;
		case 19:
			items = getResources().getStringArray(R.array.guangxi_province_item);
			...
			break;
		case 20:
			items = getResources().getStringArray(R.array.hainan_province_item);
			...
			break;
		case 21:
			items = getResources().getStringArray(R.array.chongqing_province_item);
			...
			break;
		case 22:
			items = getResources().getStringArray(R.array.sichuan_province_item);
			...
			break;
		case 23:
			items = getResources().getStringArray(R.array.guizhou_province_item);
			...
			break;
		case 24:
			items = getResources().getStringArray(R.array.yunnan_province_item);
			...
			break;
		case 25:
			items = getResources().getStringArray(R.array.xizang_province_item);
			...
			break;
		case 26:
			items = getResources().getStringArray(R.array.shanxi2_province_item);
			...
			break;
		case 27:
			items = getResources().getStringArray(R.array.gansu_province_item);
			...
			break;
		case 28:
			items = getResources().getStringArray(R.array.qinghai_province_item);
			...
			break;
		case 29:
			items = getResources().getStringArray(R.array.linxia_province_item);
			...
			break;
		case 30:
			items = getResources().getStringArray(R.array.xinjiang_province_item);
			...
			break;
		case 31:
			items = getResources().getStringArray(R.array.hongkong_province_item);
			...
			break;
		case 32:
			items = getResources().getStringArray(R.array.aomen_province_item);
			...
			break;
		case 33:
			items = getResources().getStringArray(R.array.taiwan_province_item);
	...
	private  int checkCounty(int provinceId,int cityId, String string){
		int j = 0;
	...
	private void updata(String type, final String text){
		...
		MyApplication.getInstance().getApi().updataUserinfoForJpj(user_id,type,text,new PanLvApi.ClientAjaxCallback(){
			...
			public void onSuccess(String t) {
				...
				if(data == null){
					ToastUtil.show(SetAreaActivity.this,"修改失败");
					return;
				}

				ToastUtil.show(SetAreaActivity.this,"修改成功");

				//从sqlite数据库获取用户信息
				String userid = LoginPrefereces.getNumber(SetAreaActivity.this);
